...
2.1. Premissas:
        a) O preço retornado não pode ter data anterior a um ano
        b) A data corrente do sistema é disponibilizada pelo serviço SessionDateService.
        c) O critério de desempate para dois preços iguais é a data. Portanto, se ao consultar o maior preço, dois preços forem retornados, aquele que possui data mais recente deve ser acatado.
